...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } // useParams 
function ResetPassword() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return _userService["default"].updatePassword(sendData);
            case 6:
              response = _context.sent;
              if (response.success) {
                localStorage.setItem('auth', JSON.stringify(response.data));
                _reactHotToast.toast.success("Password Updated Successfully");
                setLoading(false);
                navigate('/login');
                resetForm();
              } else {
                _reactHotToast.toast.error(response.error.message);
                setLoading(false);
              }
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, "Update Password")), /*#__PURE__*/_react["default"].createElement("img", {
    src: _Frame["default"],
    alt: "",
    ...
    htmlFor: "password",
    className: "block text-sm font-medium leading-6 me-1"
  }, "Confirm Password"), /*#__PURE__*/_react["default"].createElement("span", {
    className: "text-[#ff0000]"
  }, "*")), /*#__PURE__*/_react["default"].createElement("div", {
    className: "my-2 relative"
  }, /*#__PURE__*/_react["default"].createElement("input", {
    ...
    onChange: formik.handleChange,
    onBlur: formik.handleBlur
  }), formik.errors.confirm_password && formik.touched.confirm_password && /*#__PURE__*/_react["default"].createElement(_md.MdOutlineErrorOutline, {
    className: "text-[#ff0000] text-xl absolute right-2.5 top-2.5 "
  })), formik.errors.confirm_password && formik.touched.confirm_password ? /*#__PURE__*/_react["default"].createElement("div", {
    className: "mt-2 text-[#f80000] text-sm"
  }, formik.errors.confirm_password) : null), /*#__PURE__*/_react["default"].createElement("div", {
